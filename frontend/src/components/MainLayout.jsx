...
const MainLayout = ({ children }) => {
  ...
  const getNavigationItems = () => {
    const allItems = [
      ...
      { name: 'Giving', href: '/giving-analytics', icon: ChartBarIcon, roles: ['admin', 'finance', 'senior_leadership', 'senior_leader', 'senior_pastor', 'lead_pastor'] },
      ...
      { name: 'Prayer & Praise', href: '/prayer', icon: HeartIcon, roles: ['admin', 'senior_leadership', 'senior_leader', 'senior_pastor', 'lead_pastor', 'campus_pastor', 'pastor', 'staff'] },
